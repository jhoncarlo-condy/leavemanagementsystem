...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>DMCFI | Password Recovery</title>
                ...
                <nav class="red darken-4">
                    <div class="nav-wrapper row">
                        <section class="material-design-hamburger navigation-toggle">
                            ...
                            <i class="material-icons pnter" onclick="homefunc()">reply</i>
                        </section>
                        <div class="header-title col s3">      
                            <span class="chapter-title">DMCFI</span>
                        </div>
...
$empid=$_POST['empid'];
$email=$_POST['emailid'];
$sql ="SELECT id,FirstName,LastName FROM tblemployees WHERE EmailId=:email and EmpId=:empid";
...
foreach ($results as $result) {
 ...
 <div class="row">
          <span class="card-title" style="font-size:20px;"><b>Change your password for<?php echo htmlentities($fname . " ". $lname) ?></b></span><br>                                  
