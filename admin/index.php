...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>DMCFI | Employee Login</title>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="red darken-4">
                    <div class="nav-wrapper row ">
                        <section class="material-design-hamburger navigation-toggle">
                            <!-- <a href="#" data-activates="" class="button-collapse show-on-large material-design-hamburger__icon"> -->
                            <i class="material-icons pnter" onclick="homefunc()">home</i>
                        </section>
                        
                        <div class="header-title col s3">

                            <span class="chapter-title">DMCFI | ADMIN</span>
                        </div>
            ...
            <!-- <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    ...
                    <li class="no-padding"><a class="waves-effect waves-grey" href="login.php"><i class="material-icons">account_box</i>Employee Login</a></li>
                                      ...
                                      <span class="card-title" style="font-size:20px;">Admin Login</span>
                                       ...
                                       <div class="row">
                                           <form class="col s12" name="signin" method="post">
                                               ...
                                               <!-- <a class="waves-effect waves-grey" href="forgot-password.php"> Forgot password?</a> -->
                                               </div>
