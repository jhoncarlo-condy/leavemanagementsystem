...
<button style="margin-left:100px;" type="button" name="add" class="waves-effect waves-light btn indigo m-b-xs" ><a href="manageleavetype.php" style="color:white;">Manage Leaves</a></button>
</div>
