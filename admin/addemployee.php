...
<div class="input-field col s12">
<label for="phone">Mobile number ex.9380543069</label>
...
<button style="float:right;" type="button" name="manageemployees" class="waves-effect waves-light btn indigo m-b-xs"><a href="manageemployee.php" style="color:white;">Manage Employees</a></button>
    ...
    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Registered Employees</span>
