    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Manage Employees</div><label class="label label-xs" style="font-size: 12px">|<a href="addemployee.php">  <i class="fa fa-plus-circle fw-fa"></i> New</a> |</label> </small>
                    </div>
...
if($stats){
                                            ...
                                            <td><a href="editemployee.php?empid=<?php echo htmlentities($result->id);?>"><i class="material-icons">mode_edit</i></a></td><td>
...
<?php } else {?>
                                            ...
                                            <?php } ?> </td>
                                            <td></a><a href="manageemployee.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you want to delete');"> <i class="material-icons">delete_forever</i></a></td></td>
                                        </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                </table>
