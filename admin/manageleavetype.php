    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Manage Leave Type</div><label class="label label-xs" style="font-size: 12px">|<a href="addleavetype.php">  <i class="fa fa-plus-circle fw-fa"></i> New</a> |</label> </small>
                    </div>
