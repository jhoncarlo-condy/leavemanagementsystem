...
<button style="margin-left:90px;font-color:white;" name="add" class="waves-effect waves-light btn indigo m-b-xs"><a href="managedepartments.php" style="color:white;">Manage Departments</button></a>
