                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                <span class="card-title"><a href="manageemployee.php " style="color:gray;">Registered Employees</span>
...
?>
                                    ...
                                    <span class="counter"><?php echo htmlentities($empcount);?></span></span></a>
                            </div>
                        ...
                        <div class="card stats-card">
                            <div class="card-content">
                                <span class="card-title"><a href="manageemployee.php " style="color:gray;">Listed Departments </span>
    <?php
...
?>                            
                                <span class="stats-counter"><span class="counter"><?php echo htmlentities($dptcount);?></span></span></a>
                            </div>
                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                <span class="card-title"><a href="manageleavetype.php " style="color:gray;">Listed leave Type</span>
                                    <?php
...
?>   
                                <span class="stats-counter"><span class="counter"><?php echo htmlentities($leavtypcount);?></span></span></a>
