...
<html lang="en">
    <head>
        ...
        <link href="assets/plugins/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
         <link href="admin/fonts/font-awesome.min.css" rel="stylesheet"/> 
                    ...
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Leave History  &nbsp <label class="label label-xs" style="font-size: 12px">|    <a href="apply-leave.php">  Apply Leave <i class="fa fa-plus-circle fw-fa"></i></a>|</label> </small>
                                </span><?php if($msg){?><div class="succWrap"><strong>SUCCESS</strong> : <?php echo htmlentities($msg); ?> </div><?php }?>
